...
def main(args):
    ...
    register_coco_instances(
        "doclaynet_train",
        {},
        "/path/to/dataset/DocLayNet/DocLayNet_core/COCO/train.json",
        cfg.PUBLAYNET_DATA_DIR_TRAIN
    )
    register_coco_instances(
        "doclaynet_val",
        {},
        "/path/to/dataset/DocLayNet/DocLayNet_core/COCO/test.json",
...
#python train_net.py --config-file cascade_layoutlmv3.yaml --num-gpus 5 \
#MODEL.WEIGHTS ../../layoutlmv3-base/pytorch_model.bin \
#OUTPUT_DIR ../../fts/Doclaynet